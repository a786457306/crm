                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select name="labelTypeFirst" class="form-control tagType">
                                                            <option value="">请选择</option>
                                                            <c:forEach var="labelTypes" items="${labelTypes}">
                                                                <option value="${labelTypes.id}">${labelTypes.name}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select name="labelItemFirst" class="form-control tagItem">
                                                            <option value="">请选择</option>
                                                            <c:forEach var="labelItems1" items="${labelItems1}">
                                                                <option value="${labelItems1.id}">${labelItems1.dicLabelName}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select name="labelItemSecond" class="form-control tagItem">
                                                            <option value="">请选择</option>
                                                            <c:forEach var="labelItems2" items="${labelItems2}">
                                                                <option value="${labelItems2.id}">${labelItems2.dicLabelName}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select name="labelItemThird" class="form-control tagItem">
                                                            <option value="">请选择</option>
                                                            <c:forEach var="labelItems3" items="${labelItems3}">
                                                                <option value="${labelItems3.id}">${labelItems3.dicLabelName}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                </div>
