            ...
            <ul class="nav navbar-nav margin-left" id="header-bar">
                ...
                <li class="list">
                    ...
                    <ul class="dropdown-menu arrow" aria-labelledby="dLabel">
                        ...
                        <shiro:checkPermission name="Admin:Profile:Portrayal:Action">
                ...
                <li class="list">
                    ...
                    <ul class="dropdown-menu arrow" aria-labelledby="dLabel">
                        ...
                        <shiro:checkPermission name="Admin:Event:Template:List">
    ...
    <li id="firstMenu3" class="active firstMenu" style="display: none;">
        ...
        <ul>
            ...
            <li class="active">
                ...
                <ul>
                    <shiro:checkPermission name="Admin:Event:Prepare:Notice:List">
