                            ...
                            <form class="form-horizontal J_searchForm  J_tableForm">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="w180 J_tableName" type="text" name="idcardNum" data-valid-rule="notNull&isNumber" value="${idCardNum}" readonly="readonly"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="w180 J_tableName" type="text"   value="${tel}" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">
