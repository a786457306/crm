                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="w180" type="text" name="secContact" readonly="readonly" value="${secContract}"/>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="w180" type="text" name="diagnoseType" readonly="readonly" value="${diagnoseType}"/>
                                        </div>
                                    </div>
                                </div>
                                <!-- 右侧内容start -->
                            ...
                            <div class="panel-body">
                                <div class="col-sm-5">
                                    ...
                                    <!-- <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-sm-6">
                                        <textarea class="w180" readonly="readonly" name="hospitalization">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</textarea>
                                        </div>
                                    </div> -->
                                </div>
                                <!-- 右侧内容start -->
