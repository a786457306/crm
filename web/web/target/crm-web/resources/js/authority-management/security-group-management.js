...
$(function(){
            ...
            success: function (rs) {
                ...
                if( rs.code == 0){
                    $.each(rs.list, function(index, item){
                        str += '<tr data-id="'+ item.id +'" data-express="'+ item.name +'" data-description="'+ item.description +'">\
                                    <td>'+ item.name +'</td>\
                                    <td>'+ item.description +'</td>\
                                    <td>\
                                        <a href="#" class="label-info J_edit" data-toggle="modal" data-target="#editDialog"><i class="fa fa-pencil"></i>&nbsp;编辑</a>\
                                        <a href="/admin/party/security/group/permission/'+ item.id +'" class="label-info"><i class="fa fa-book"></i>&nbsp;查看权限</a>\
                                    </td>\
                                </tr>'
                    });
                ...
                $('#pageLimit').bootstrapPaginator({totalPages: rs.dateCount});
            },
    ...
    function edit(){
        ...
        $.ajax({
            type: "PUT",
            url: "/admin/party/security/group/ajax/update",
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
    ...
    function add(){
        ...
        $.ajax({
            type: "POST",
            url: "/admin/party/security/group/ajax/new",
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: form,     //JSON.stringify
            dataType: "json",
            success: function (rs) {
    ...
    function del(){
        ...
        $.ajax({
            type: "post",
            url: "/admin/party/security/group/ajax/del",
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            data: form,     //JSON.stringify
            dataType: "json",
            success: function (rs) {
